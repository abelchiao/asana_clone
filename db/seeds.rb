...
Project.create!(title: 'General operations', owner_id: 1, team_id: 1, description: 'done', section_order: [1, 2, 3, 4])
Project.create!(title: 'Projects MVP', owner_id: 1, team_id: 1, description: 'asfafafldj', section_order: [5, 6, 7, 8])
...
Section.create!(project_id: 1, title: 'Planning', task_order: [1, 2, 3, 4, 5, 6])
Section.create!(project_id: 1, title: 'Milestones', task_order: [7, 8, 9, 10, 14])
Section.create!(project_id: 1, title: 'Next steps', task_order: [11, 12, 13, 15, 16])
Section.create!(project_id: 1, title: 'Backlogged ideas', task_order: [17, 18, 19])
